...
import net.cpollet.sportracker.quantities.AngleQuantity;
...
public class QuantitySteps {
	...
	public void setUp() {
		...
		quantityClasses.put("angle", AngleQuantity.class);
		...
		insertUnit(AngleUnit.deg);
		insertUnit(AngleUnit.semicircle);
	}
